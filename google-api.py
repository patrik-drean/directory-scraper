...
def authenticate():
  creds = None
  if os.path.exists(f'{BASE_PATH}/directory-scraper/token.pickle'):
      with open(f'{BASE_PATH}/directory-scraper/token.pickle', 'rb') as token:
  ...
  if not creds or not creds.valid:
      ...
      with open(f'{BASE_PATH}/directory-scraper/token.pickle', 'wb') as token:
